        ...
        return axios.post('https://sv-crm-cybersoft.herokuapp.com/api/course/getCourse?page=1')
            .then((res) => {
                ...
                res.data.forEach(el => {
                    ...
                    el.DanhSachGiangVien = el.DanhSachGiangVien.toString()
                    /*.map((val) => {
                                            return val + ", ";
                                        });
                    ...
                    */
                    el.DanhSachMentor = el.DanhSachMentor.toString()
                    /*.map((val, key) => {
                                            return val + ", ";
                                        });
                    ...
                    */
                    ...
                    el.ThoiGianHoc = el.ThoiGianHoc.BatDau + " - " + el.ThoiGianHoc.KetThuc;
